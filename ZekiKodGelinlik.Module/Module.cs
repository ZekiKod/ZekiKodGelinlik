...
public sealed class ZekiKodGelinlikModule : ModuleBase {
    public ZekiKodGelinlikModule() {
        // 
        // ZekiKodGelinlikModule
        // 
        AdditionalExportedTypes.Add(typeof(SiparisKarti));
        AdditionalExportedTypes.Add(typeof(SiparisFoy));
