...
namespace Sirketiz.Module.BusinessObjects.Sirket_izDB
{
    ...
    public partial class kisi_avans : XPObject
    {
        DateTime ftarih;
        ...
        short foran;
        [DevExpress.Xpo.DisplayName(@"Oran")]
        public short oran
        {
            get { return foran; }
            set { SetPropertyValue<short>(nameof(oran), ref foran, value); }
        }
        string faciklama;
        ...
        [Association(@"kisi_avansReferenceskisi_kartlari")]
